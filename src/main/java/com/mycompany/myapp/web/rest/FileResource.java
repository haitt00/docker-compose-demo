        ...
        Optional<File> result = fileRepository
            ...
            .map(existingFile -> {
                ...
                if (file.getFileContent() != null) {
                    existingFile.setFileContent(file.getFileContent());
                }
                if (file.getFileContentContentType() != null) {
                    existingFile.setFileContentContentType(file.getFileContentContentType());
                }
                if (file.getFileSize() != null) {
                    existingFile.setFileSize(file.getFileSize());
                }
                if (file.getFileMimeType() != null) {
                    existingFile.setFileMimeType(file.getFileMimeType());
                }
